...
| توضیحات | لینک سابسکرپشن |
| :--- | :--- |
| کانفیگ‌های بدون آی‌پی کلودفلر (۷۲ ساعته) | [لینک سابسکرپشن](https://raw.githubusercontent.com/r3zarahimi/tg-v2ray-configs-every2h/main/Config_no_cf.txt) |
