...
# اطلاعات API تلگرام (توصیه می‌شود از متغیرهای محیطی خوانده شود)
# در صورت عدم تنظیم متغیر محیطی، از مقادیر زیر استفاده می‌شود
API_ID = os.environ.get("API_ID", 25129828)
API_HASH = os.environ.get("API_HASH", "35ee9ce4b40c60327b8e6c5eb5f89f61")
...
if __name__ == "__main__":
    # حذف فایل سشن قدیمی برای اطمینان از لاگین جدید
